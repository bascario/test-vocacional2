<?php
/**
 * Controlador para la gestión de preguntas del test vocacional.
 * Permite listar, buscar, importar y eliminar preguntas.
 */
class QuestionController
{
    ...
    /**
     * Listar preguntas con opción de búsqueda y filtros.
     */
    ...
    /**
     * Importar preguntas masivamente desde archivo Excel/Word.
     */
     ...
     *
     * @param array $file Archivo subido ($_FILES['key']).
